...
export default function PushUpTimer2() {
  ...
  return (
    <>
      <div>
        <ClockTB play={play} setPlay={setPlay} freeStyle={false} time={2} navigateObject={navigateObject} setShowContinueBtn={setShowContinueBtn} />
        <RoundedButtonTB play={play} setPlay={setPlay} ></RoundedButtonTB>
        <AudioChangeRate play={play} setDataNewLpm={setDataNewLpm} />
      </div>
      <div>
        {showContinueBtn && (
